...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/reportportal-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13430&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/reportportal-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `reportportal-client` can be installed with:

```
conda install reportportal-client
```

It is possible to list all of the versions of `reportportal-client` available on your platform with:
